Shader "FlatLighting/Baked/groundtexturemap" {
	Properties {
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" 
			   "FlatLightingBakedTag"="FL_COLORS_WORLD;FL_GRADIENT_LOCAL;FL_DIRECTIONAL_LIGHT;FL_RECEIVESHADOWS;FL_MAIN_TEXTURE"
			}
